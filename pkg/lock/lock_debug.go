...
const (
	...
	// Note: When changing this value please change the value in selfishThresholdMsg.
	selfishThresholdSec = 0.1

	// selfishThresholdMsg is the message that will be printed when a lock was
	// held for more than 0.1. This message is a constant to avoid generating
	// this string every time the log message is printed.
	selfishThresholdMsg = "Goroutine took lock for more than 0.1 seconds"
