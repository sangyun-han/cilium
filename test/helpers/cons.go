...
const (
	...
	selfishThresholdMsg = "Goroutine took lock for more than 0.1 seconds" // from https://github.com/cilium/cilium/pull/5268
...
var checkLogsMessages = []string{panicMessage, deadLockHeader, segmentationFault, NACKreceived, RunInitFailed, selfishThresholdMsg}
